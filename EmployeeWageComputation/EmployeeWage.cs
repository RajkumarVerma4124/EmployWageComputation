...
namespace EmployeeWageComputation
{
    ...
    internal class EmployeeWage
    {
        ...
        public static int ComputeMonthlyWage(string company, string name, int wagePerHours, int dailyHours, int dayPerMonth, int totalHours)
        {
            // local Variable
